...
const messages: Record<MessageKey_defaultSet, string> = {
    ...
    "loginAccountTitle": '<div style="font-size: 25px; font-weight: 700;">Đăng nhập</div><div style="font-size: 14px; color: #64748b; font-weight: 600">Sử dụng username và password để đăng nhập</div>',
    ...
    "loginTimeout": "Phiên đăng nhập của bạn đã kết thúc. Bạn sẽ tiến hành đăng nhập từ đầu.",
    ...
    "errorTitle": "Xảy ra lỗi...",
    "errorTitleHtml": "We are <strong>sorry</strong> ...",
    "emailVerifyTitle": "Email verification",
    "emailForgotTitle": '<div style="font-size: 25px; font-weight: 700;">Quên mật khẩu</div><div style="font-size: 14px; color: #64748b; font-weight: 600">Điền thông tin email hoặc username để cài đặt lại mật khẩu</div>',
    ...
    "updatePasswordTitle": '<div style="font-size: 25px; font-weight: 700;">Thay đổi mật khẩu</div><div style="font-size: 14px; color: #64748b; font-weight: 600">Thay đổi mật khẩu</div>',
    ...
    "email": "Email",
    "password": "Password",
    "passwordConfirm": "Nhập lại password",
    "passwordNew": "Password",
    "passwordNewConfirm": "New Password confirmation",
    "hidePassword": "Hide password",
    "showPassword": "Show password",
    "rememberMe": "<div style='color: black; font-weight: 600'>Nhớ đăng nhập</div>",
    ...
    "logoutOtherSessions": "<div style='color: black; font-weight: 600'>Đăng xuất thiết bị khác</div>",
    ...
    "backToLogin": "&laquo Quay lại màn hình đăng nhập",
    "emailInstruction": "Nhập username hoặc email chúng tôi sẽ gửi hướng dẫn để tạo mật khẩu mới.",
    ...
    "invalidUserMessage": "Mật khẩu hoặc username không đúng",
    "invalidUsernameMessage": "Username không đúng.",
    "invalidUsernameOrEmailMessage": "Username hoặc email không đúng.",
    ...
    "missingPasswordMessage": "Chưa điền thông tin mật khẩu.",
    "missingTotpMessage": "Please specify authenticator code.",
    "missingTotpDeviceNameMessage": "Please specify device name.",
    "notMatchPasswordMessage": "Mật khẩu không trùng khớp.",
    ...
    "emailSentMessage": "Bạn sẽ sớm nhận được email với hướng dẫn thực hiện các bước tiếp",
    "emailSendErrorMessage": "Gửi email thất bại, vui lòng thử lại",
    ...
    "identity-provider-login-label": "Đăng nhập bằng",
